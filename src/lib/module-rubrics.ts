      ...
      "Reflective Essay": [
        {
          ...
          levels: {
            excellent:
              "30-40: Deep, critical reflection; demonstrates strong integration of personal experience with theory; nuanced insights",
            ...
            satisfactory:
              "24-27: Adequate reflection; some links between experience and theory, but often surface-level or inconsistent",
            basic:
              "20-23: Limited reflection; mainly descriptive with weak or vague theoretical connections",
        ...
        },
        {
          ...
          description:
            "Supports reflection with theory, course content, and/or scholarly sources",
          maxMark: 25,
          levels: {
            excellent:
              "19-25: Consistently applies relevant theory and literature to support reflection; strong and accurate use of sources",
            good: "18: Generally good use of theory with minor gaps or limited depth",
            satisfactory:
              "15-17: Some evidence used, though uneven, superficial, or occasionally inaccurate",
            basic:
              "13-14: Minimal use of theory; weak engagement with course content",
        ...
        },
        {
          ...
          description:
            "Demonstrates self-awareness and growth; identifies strengths and growth areas with honesty and depth",
          maxMark: 15,
          levels: {
            excellent:
              "12-15: Strong self-awareness; clearly identifies strengths and growth areas with honesty and depth",
            good: "11: Good self-awareness; strengths and growth areas identified with some depth",
            satisfactory:
              "9-10: Adequate self-awareness; some areas noted, but limited reflection on growth",
            basic:
              "8: Minimal self-awareness; vague or generic comments about strengths and growth",
        ...
        },
        {
          ...
          levels: {
            excellent:
              "8-10: Exceptionally clear, well-structured, coherent, and engaging; error-free",
            good: "7: Clear and well-structured with only minor language issues",
            satisfactory:
              "6: Adequately structured; some clarity or grammar issues",
            basic:
              "5: Weak structure; frequent errors that affect readability",
        ...
        },
        {
          ...
          levels: {
            excellent:
              "8-10: Accurate and consistent referencing throughout; correct style applied",
            good: "7: Minor referencing errors; mostly consistent",
            satisfactory:
              "6: Some referencing attempted but with noticeable errors",
            basic:
              "5: Minimal or inconsistent use of referencing",
      ...
      Presentation: [
        {
          ...
          description:
            "Demonstrates deep insight into the chosen community, life skills needs, facilitation, and self-reflection",
          maxMark: 30,
          levels: {
            excellent:
              "26-30: Demonstrates deep insight into the chosen community, life skills needs, facilitation, and self-reflection. Shows critical and personal engagement.",
            good: "24-25: Good insight with some depth of reflection. Minor gaps in critical engagement.",
            satisfactory:
              "21-23: Adequate insight; reflection tends to be more descriptive than critical.",
            basic:
              "18-20: Limited insight; reflection is brief or superficial.",
        ...
        },
        {
          ...
          description:
            "Integrates theory from class readings clearly and effectively; strong connection between theory and community needs",
          maxMark: 25,
          levels: {
            excellent:
              "23-25: Integrates theory from at least 2 class readings clearly and effectively. Strong connection between theory and community needs.",
            good: "21-22: Good use of theory with clear relevance; some minor gaps in application.",
            satisfactory:
              "18-20: Uses theory but mostly descriptive; connections to community needs not always clear.",
            basic:
              "15-17: Minimal use of theory; weak or vague link to community.",
        ...
        },
        {
          ...
          description:
            "Clear, practical, and creative plan with title, aim, objectives, activities, and materials well-suited to community needs",
          maxMark: 25,
          levels: {
            excellent:
              "23-25: Clear, practical, and creative plan with title, aim, objectives, activities, and materials. Activities well-suited to community needs.",
            good: "21-22: Good plan with most required elements; activities mostly relevant.",
            satisfactory:
              "18-20: Adequate plan; some elements missing or unclear; activities somewhat relevant.",
            basic:
              "15-17: Basic plan with significant gaps; little detail in activities or materials.",
        ...
        },
        {
          name: "Communication",
          description:
            "Report and slides are well-structured, clear, and polished; correct grammar, spelling, and academic style throughout",
          maxMark: 10,
          levels: {
            excellent:
              "9-10: Report and slides are well-structured, clear, and polished; correct grammar, spelling, and academic style throughout.",
            good: "8: Mostly well-written with minor errors. Clear structure.",
            satisfactory:
              "7: Adequately written with some errors or inconsistencies in clarity/structure.",
        ...
        },
        {
          name: "Referencing",
          description:
            "Consistent and correct use of APA 7th edition referencing throughout",
          maxMark: 10,
          levels: {
            excellent:
              "9-10: Consistent and correct use of APA 7th edition referencing throughout.",
            good: "8: Minor errors in APA referencing.",
            satisfactory:
              "7: Some errors or inconsistencies in APA referencing.",
