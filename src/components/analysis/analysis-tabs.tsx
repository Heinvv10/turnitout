...
import { ShieldCheck, BookOpen, GraduationCap, FileOutput, Search, Lightbulb } from "lucide-react";
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <Tabs defaultValue="ai-risk" className="flex flex-1 flex-col">
        ...
        <TabsContent value="plagiarism" className="flex-1 overflow-y-auto p-4">
          <PlagiarismPanel />
        </TabsContent>
